function validar(){
        ...
        entrada.push(document.getElementById('direccion').value);
        entrada.push(document.getElementById('rut').value);
        entrada.push(document.getElementById('password').value);
        entrada.push(document.getElementById('confirmarpassword').value);
        ...
        entradasError.push("errorDireccion");
        entradasError.push("errorRut");
        ...
        error.push("<span style='color: red'>La dirección no es válida</span>");
        error.push("<span style='color: red'>El RUT no es válido</span>");
        ...
        for(i in entrada){
            ...
            //Validar password
                ...
                let segundo = document.getElementById('confirmarpassword').value;
